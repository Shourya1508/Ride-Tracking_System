...
//    
    ...
    public Ride createRide(@RequestBody Ride rideRequest) {
        ...
        notificationPublisher.sendRideNotification(email, "Hey "+user.getName()+", your  ride has been started! Enjoy your ride");
        ...
        System.out.println("pickup Lon:"+pickupLon+" pickupLat: "+pickupLat);
        ...
        System.out.println(" dropLon:"+dropLon+" dropLat: "+dropLat);

        // STEP 4: Assign driver — simple static logic for now
        Long assignedDriverId = rideRequest.getDriverId();  // choose logic later
