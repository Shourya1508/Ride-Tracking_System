...
<body>
	...
	int mast_code = 0;
     ...
     mast_code = (int)request.getAttribute("mast");
	...
	String desigvalue = null;
	String depvalue = null;
	String joined_date_value = null;
	String salaryvalue = null;
	String adr1_value = null;
	String adr2_value = null;
	...
	int user_id = (int) sess.getAttribute("USER_ID");
		...
		try (Connection con = DbConnection.getConnection()) {
			...
			PreparedStatement ps1 = con.prepareStatement("select * from employee_data where id =? and mast_code=?");
		...
		adr1_value = rs1.getString("addressline1");
		adr2_value = rs1.getString("addressline2");
		city_value = rs1.getString("city");
		state_value = rs1.getString("state");
		country_value = rs1.getString("country");
	...
	<div class="text">
		...
		<div class="testbox">
			<form id="registrationForm" method="post" action="EditEmployee" onsubmit="return validateForm();">
				<div class="banner">
				...
				<div class="item">
				<input type="hidden" name="code" value="<%=mast_code %>">
					<label for="id">Emp_Id<span>*</span></label> <input id="id"
						type="text" name="emp_id"
						value="<%=empvalue == null ? "" : empvalue%>"> 
				</div>
				<div class="item">
					<label for="emp_name">Emp_Name<span>*</span></label> <input
						id="empname" type="text" name="emp_name"
				...
				<div class="item">
					<label for="department">Department<span>*</span></label> <input
						id="dep" type="text" name="department" placeholder="Department"
						value="<%=depvalue == null ? "" : depvalue%>"> 
				</div>
				<div class="item">
					<label for="j_d">Joined_date<span>*</span></label> <input id="j_d"
						type="date" name="joined_date" placeholder=""
						value="<%=joined_date_value == null ? "" : joined_date_value%>">
					
				</div>
				<div class="item">
					<label for="salary">Salary<span>*</span></label> <input id="sal"
				...
				<div class="item">
					<label for="adr1">Addressline1<span>*</span></label> <input
						id="adr1" type="text" name="addressline1" placeholder="Address_1"
						value="<%=adr1_value == null ? "" : adr1_value%>"> 
				</div>
				<div class="item">
					<label for="adr2">Addressline2<span>*</span></label> <input
						id="adr2" type="text" name="addressline2" placeholder="Address_2"
						value="<%=adr2_value == null ? "" : adr2_value%>"> 
				</div>
				<div class="item">
					<label for="city">City<span>*</span></label> <input id="ct"
						type="text" name="city" placeholder="city"
						value="<%=city_value == null ? "" : city_value%>">
				</div>
				<div class="item">
					<label for="state">State<span>*</span></label> <input id="st"
						type="text" name="state" placeholder="State"
						value="<%=state_value == null ? "" : state_value%>">
				</div>
				<div class="item">
					<label for="country">Country<span>*</span></label> <input id="con"
						type="text" name="country" placeholder="Country"
						value="<%=country_value == null ? "" : country_value%>"> 
				</div>
				<div class="btn-block">
					<button type="submit">Update</button>
					<button type="submit" onclick="redirectToList()">Back</button>
				</div>
			</form>
		</div>
	</div>
