...
<%
	...
	<div class="text">
		...
		<div class="testbox">
				<form id="registrationForm" method="post" action="ResetPass" onsubmit="return validateForm();">
				<div class="banner">
	...
	<div class="item">
					<label for="password">Password<span>*</span></label> <input type="password"
						id="password" type="text" name="set_pass"
				...
				<div class="item">
					<label for="conpass">Confirm Password<span>*</span></label> <input type="password"
						id="conpass" type="text" name="set_con_pass"
				...
				<div class="btn-block">
					...
					<button type="submit" name="action" value="back" onclick="redirectToLogin()">Back</button>
				</div>
