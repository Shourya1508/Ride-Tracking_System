...
response.setHeader("X-Frame-Options", "DENY");
	...
	<div class="text">
		...
		<div class="testbox">
			<form id="registrationForm" method="post" action="Servlett" onsubmit="return validateForm();">
				<div class="banner">
				...
				<div class="item">
					<label for="password">Password<span>*</span></label> <input
						...
						value="<%=pass_value == null ? "" : pass_value%>">
						  <i class="eye-icon toggle-password" onclick="togglePasswordVisibility()">&#128065;</i>
				...
				<div class="item">
					<label for="conpass">Confirm Password<span>*</span></label> <input
						...
						value="<%=cpass_value == null ? "" : cpass_value%>"> 
						  <i class="eye-icon toggle-password" onclick="togglePasswordVisibility1()">&#128065;</i>
						
						
				</div>
				<div class="btn-block">
					<button type="submit" name="action" value="reg">Register</button>
					<button type="submit" name="action" onclick="redirectToLogin()" value="log">Login</button>
				</div>
			</form>
		</div>
	</div>
