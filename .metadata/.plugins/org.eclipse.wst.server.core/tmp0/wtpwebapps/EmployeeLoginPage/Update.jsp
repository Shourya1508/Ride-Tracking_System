...
try(Connection con = DbConnection.getConnection()){
	...
	while(rs.next()){
		...
		number_value = rs.getString("mobile_no");
		email_value = rs.getString("email");
		pass_value = rs.getString("pass");
		cpass_value = rs.getString("confirm_pass");
			...
			<form method="post" action="updateUser">
				...
				<div class="item">
					<label for="password">Password<span>*</span></label> <input type="password"
						...
						value="<%=pass_value == null ? "" : pass_value%>"> <span
				...
				<div class="item">
					<label for="conpass">Confirm Password<span>*</span></label> <input type="password"
						...
						value="<%=cpass_value == null ? "" : cpass_value%>"> <span
