...
String passvalue = (String)request.getAttribute("set_password");
String passV = (String) request.getAttribute("passErr");
String conpassvalue = (String)request.getAttribute("confirmPass");
String conV = (String) request.getAttribute("conErr");
...
<div class="container">
  ...
  <form method="post" action="forgotPass">
    <input type="text" class="email" placeholder="Email" name="verify_email"
...
<%= emailV==null ?"":emailV %>
    ...
    <br/>
    <input type="text" class="pwd" placeholder="Password" name="set_pass"
...
<%= passV==null ?"":passV %>
    ...
    <br>
    <input type="text" class="pwd" placeholder="Confirm Password" name="set_con_pass"
    value="<%=conpassvalue == null? "":conpassvalue %>"/>
    <div class="span">
<span class="error">
<%= conV==null ?"":conV %>
</span>
